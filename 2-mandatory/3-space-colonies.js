/*
  ...
  They call the planet "Alpha" and they decide that the FAMILIES whose last names start with 'A' should stay, while the others go on in search of other planets to call home.
...
function getSettlers(obj) {
  let findSettlers = obj.filter((obj) => obj[0] === "A" && obj.includes("family"));
  return findSettlers;
}
