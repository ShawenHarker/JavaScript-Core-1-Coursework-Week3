...
/*
  ...
  The input provided contains a list of locations in London. Each of the locations is followed by a list of transport modes that can be used to get there.
...
function getTransportModes(arr) {
  let transportModes = arr.slice(1);
...
function journeyPlanner(locations, transportMode) {
  return locations.filter((el) => el.slice(1)
